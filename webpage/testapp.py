...
local_css("webpage/style/style.css")
...
with st.container():
	...
	st.write("##")
	image_column, text_column = st.columns((1, 2)) #text_column size 2, image_column size 1
	with image_column:
		#insert
...
with st.container():
	...
	with text_column:
		...
		st.write(
			...
			Animations make our web app more engaging and fun, and Lottie Files are the easiest way to do it
			In this video, I'm going to show you how to implement a contact form using the free service "From Submit" 
			"""
			)
		st.markdown("[Watch Video...](https://www.youtube.com/results?search_query=streamlit+python)")
...
with st.container():
	...
	#Reference: https://formsubmit.co/
	contact_form = """
	<form action="https://formsubmit.co/a177313@siswa.ukm.edu.my" method="POST">
